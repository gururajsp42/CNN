...
REM
REM Generated by Vivado on Sat Aug 23 23:03:49 +0530 2025
...
echo "xvlog --incr --relax -L uvm -prj tb_cnn_layer_6filters_vlog.prj"
call xvlog  --incr --relax -L uvm -prj tb_cnn_layer_6filters_vlog.prj -log xvlog.log
